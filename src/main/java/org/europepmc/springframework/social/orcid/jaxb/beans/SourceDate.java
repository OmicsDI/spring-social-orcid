...
/**
 * The date time that the source client application
 * 				(Member organization system) or individual user created/attempted to
 * 				create the item.
 * 			
 * 
 * <p>Java class for source-date complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="source-date">
 *   &lt;simpleContent>
...
@XmlType(name = "source-date", namespace = "http://www.orcid.org/ns/history", propOrder = {
    "value"
})
