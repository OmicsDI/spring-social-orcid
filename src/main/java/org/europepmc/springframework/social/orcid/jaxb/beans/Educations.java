...
@XmlType(name = "educations", namespace = "http://www.orcid.org/ns/activities", propOrder = {
    "lastModifiedDate",
    "educationSummaries"
})
@XmlSeeAlso({
    ...
    implements Serializable
{
    ...
    protected List<EducationSummary> educationSummaries;
    ...
    /**
     * Gets the value of the educationSummaries property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the educationSummaries property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEducationSummaries().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EducationSummary> getEducationSummaries() {
        if (educationSummaries == null) {
            educationSummaries = new ArrayList<EducationSummary>();
        }
        return this.educationSummaries;
    }
