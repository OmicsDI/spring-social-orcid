...
@XmlType(name = "funding-group", namespace = "http://www.orcid.org/ns/activities", propOrder = {
    "lastModifiedDate",
    "externalIds",
    "fundingSummaries"
})
    ...
    implements Serializable
{
    ...
    protected List<FundingSummary> fundingSummaries;
    ...
    /**
     * Gets the value of the fundingSummaries property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fundingSummaries property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFundingSummaries().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<FundingSummary> getFundingSummaries() {
        if (fundingSummaries == null) {
            fundingSummaries = new ArrayList<FundingSummary>();
        }
        return this.fundingSummaries;
    }
